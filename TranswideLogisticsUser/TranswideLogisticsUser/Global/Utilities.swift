...
class Utilities {
 ...
 static func readJson(fileName:String) -> Any {
   ...
   static func archiveUserObject(user:UserViewModel,isloggedIn:Bool? = false)  {
...
//    }
    ...
    static func getDateFromString(string:String) -> String {
        let dateFormatter = DateFormatter()
        dateFormatter.dateFormat = "yyyy-MM-dd'T'HH:mm:ss.SS"
        let date = dateFormatter.date(from: string) ?? Date()
        return self.getStringFromDate(date: date)
    }
...
//        return formatter.date(from: temp) ?? Date()
    ...
    static func getCurrentDateString() -> String{
        ...
        formatter.dateFormat = "dd-MMM-yyyy hh:mm a"//"dd MMM YYYY"
        let timeStemp = formatter.string(from: date)
    ...
    static func getFormattedDateString(strDate:String) -> String{
