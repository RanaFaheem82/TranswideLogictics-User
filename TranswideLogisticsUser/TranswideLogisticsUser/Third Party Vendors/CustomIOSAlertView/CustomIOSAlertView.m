...
- (void)show
{
    ...
    self.backgroundColor = [UIColor colorWithRed:0 green:0 blue:0 alpha:0.7];//[UIColor colorWithRed:27/255.0 green:25/255.0 blue:129/255.0 alpha:0.8];//[UIColor colorWithRed:1 green:1 blue:1 alpha:0.9];
        ...
        // On iOS8, just place the dialog in the middle
            ...
            CGSize keyboardSize = CGSizeMake(0, 0);
                ...
                [UIView animateWithDuration:0.2f delay:0.0 options:UIViewAnimationOptionCurveEaseInOut
                                 animations:^{
                                     self.backgroundColor = [UIColor colorWithRed:0 green:0 blue:0 alpha:0.7];//[UIColor colorWithRed:27/255.0 green:25/255.0 blue:129/255.0 alpha:0.8f];//[UIColor colorWithRed:1 green:1 blue:1 alpha:0.9];
